...
function createMCTileLayer(mapName, mapConfig, mapRotation) {
	let cdnurl;
	mapName == "season6" ? cdnurl="https://maps3cdn.confusion.pt"+ `/${mapName}/world_topdown_day/`
	: cdnurl = "https://maps3cdn.confusion.pt"+ `/${mapName}/world_topdown_day_final/`; 
...
MapcrafterUI.prototype.init = function() {
	...
	this.lmap = L.map("mcmap", {
		crs: L.CRS.Simple
	}).setView([40000, 40000], 0, {animate: false});
	this.lmap.attributionControl.setPrefix("<a href='http://leafletjs.com/'>Leaflet</a> & <a href='http://mapcrafter.org'>Mapcrafter</a>");

	this.lmap.attributionControl.addAttribution(`Map rendered by <a href='https://www.reddit.com/r/HermitCraft/comments/fijfa4/3d_maps_from_season_17_now_available/'>u/Dinip12</a>, Dinip#7890.`);

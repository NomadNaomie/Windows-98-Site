...
MarkerControl.prototype.create = function(wrapper) {
	...
	buttonBack.addEventListener("click", function(handler) {
		return function() {
			window.location.href = "https://hermitcraftmaps.confusion.pt/";
		}
	}(this.handler));
	...
	addMarkers.addEventListener("click", function(handler) {
		return function() {
			window.location.href = "https://github.com/Dinip/hermitcraft/";
		}
	}(this.handler));
